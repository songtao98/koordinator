	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			raw := &Config{
				...
				CollectInterferenceIntervalSeconds:   tt.fields.CollectInterferenceIntervalSeconds,
				CollectInterferenceTimeWindowSeconds: tt.fields.CollectInterferenceTimeWindowSeconds,
			}
			c := NewDefaultConfig()
